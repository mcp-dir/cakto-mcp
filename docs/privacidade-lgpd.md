...
Cakto segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Cakto** | BR | payment gateway / checkout platform API (data provider) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [cakto@mcp.ai](mailto:cakto@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
